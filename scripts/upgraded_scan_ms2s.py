...
class MSRunPeakFinder:
    ...
    def get_theoretical_ions(self):
        ...
        for acid in amino_acids:
            for ion in ion_types:
                ...
                if ion == 'a':
                    ...
                    self.known_ions.append([int(100000 * (base_acid_mz + 1.00335)) / 100000, 'I' + acid + '+i', False])
                ...
                # add b and y ions
                    ...
                    self.known_ions.append([int(100000 * (base_acid_mz + 1.00335)) / 100000, ion + '-' + acid + '+i', False])
        ...
        self.known_ions.append([229.162932 + proton_mass, "TMT6Nterm", False])
